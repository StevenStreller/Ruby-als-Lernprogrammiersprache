...
Hinsichtlich Literatur, also Lehr- und Sachbüchern lässt die Dokumentation der Sprache \textit{\glqq Ruby\grqq} zu wünschen übrig. Es gibt zwar einige Bücher, diese sind aber in der Regel schon etwas älter und dementsprechend nicht mehr kompatibel mit dem heutigen Stand der Sprache. Besonders schwierig ist es gute Literaturbücher in der deutschen Sprache zu finden (https://wiki.ruby-portal.de/Literatur.html). Im Gegensatz dazu gibt es aber einige gute Tutorials (auch auf Deutsch) um sich das Programmieren mit \textit{\glqq Ruby\grqq} selbst beizubringen.
\end{flushleft}
